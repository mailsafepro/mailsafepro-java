...
public class CheckoutRequest {
  ...
  public CheckoutRequest plan(@javax.annotation.Nonnull String plan) {
    this.plan = plan;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.plan, checkoutRequest.plan);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckoutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CheckoutRequest is not found in the empty JSON string", CheckoutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckoutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CheckoutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
