...
|------------- | ------------- | -------------|
| [**clearRequestLogsLogsLogsRequestsDelete**](DeveloperToolsApi.md#clearRequestLogsLogsLogsRequestsDelete) | **DELETE** /logs/logs/requests | Clear Request Logs |
| [**getRequestLogsLogsLogsRequestsGet**](DeveloperToolsApi.md#getRequestLogsLogsLogsRequestsGet) | **GET** /logs/logs/requests | Get Request Logs |
...
import com.mailsafepro.api.DeveloperToolsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    DeveloperToolsApi apiInstance = new DeveloperToolsApi(defaultClient);
    try {
      Object result = apiInstance.clearRequestLogsLogsLogsRequestsDelete();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DeveloperToolsApi#clearRequestLogsLogsLogsRequestsDelete");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling DeveloperToolsApi#getRequestLogsLogsLogsRequestsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
